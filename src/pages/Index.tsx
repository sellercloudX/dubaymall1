...
const T = {
  uz: {
    ...
    pricingStarterDesc: '1 kunlik sinov, keyin 99,000 so\'m/oy aktivatsiya',
    pricingStarterFeatures: ['1 ta do\'kon/marketplace', 'Analitika va hisobotlar', 'Buyurtmalarni boshqarish', 'AI xizmatlar — balans orqali'],
    pricingBusinessTitle: 'Business',
    pricingBusinessPrice: '990 000 so\'m',
    pricingBusinessDesc: '3 ta do\'kon, AI 20% arzon, oyiga 10 ta bepul karta',
    pricingBusinessFeatures: ['Starter\'dagi barcha imkoniyatlar', '3 ta do\'kon/marketplace', 'AI xizmatlar 20% arzon', '10 ta bepul karta/klonlash oyiga'],
    pricingProTitle: 'Pro',
    pricingProPrice: '2 490 000 so\'m',
    pricingProDesc: '5 ta do\'kon, AI 40% arzon, oyiga 50 ta bepul karta',
    pricingProFeatures: ['Business\'dagi barcha imkoniyatlar', '5 ta do\'kon/marketplace', 'AI xizmatlar 40% arzon', '50 ta bepul karta/klonlash oyiga'],
    pricingEnterpriseTitle: 'Enterprise',
    pricingEnterprisePrice: '4 990 000 so\'m',
    pricingEnterpriseDesc: 'Cheksiz do\'kon, AI 50% arzon, 100 ta bepul karta',
    pricingEnterpriseFeatures: ['Pro\'dagi barcha imkoniyatlar', 'Cheksiz do\'kon', 'AI xizmatlar 50% arzon', '100 ta bepul karta + SLA'],
  },
  ru: {
    ...
    pricingStarterDesc: '1 день пробный, затем 99 000 сум/мес активация',
    pricingStarterFeatures: ['1 магазин/маркетплейс', 'Аналитика и отчёты', 'Управление заказами', 'AI-сервисы — через баланс'],
    pricingBusinessTitle: 'Business',
    pricingBusinessPrice: '990 000 сум',
    pricingBusinessDesc: '3 магазина, AI на 20% дешевле, 10 бесплатных карточек/мес',
    pricingBusinessFeatures: ['Все возможности Starter', '3 магазина/маркетплейс', 'AI-сервисы на 20% дешевле', '10 бесплатных карточек/клонирований'],
    pricingProTitle: 'Pro',
    pricingProPrice: '2 490 000 сум',
    pricingProDesc: '5 магазинов, AI на 40% дешевле, 50 бесплатных карточек/мес',
    pricingProFeatures: ['Все возможности Business', '5 магазинов/маркетплейс', 'AI-сервисы на 40% дешевле', '50 бесплатных карточек/клонирований'],
    pricingEnterpriseTitle: 'Enterprise',
    pricingEnterprisePrice: '4 990 000 сум',
    pricingEnterpriseDesc: 'Безлимит магазинов, AI на 50% дешевле, 100 карточек',
    pricingEnterpriseFeatures: ['Все возможности Pro', 'Безлимит магазинов', 'AI-сервисы на 50% дешевле', '100 бесплатных карточек + SLA'],
  },
  en: {
