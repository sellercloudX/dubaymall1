...
const T = {
  ...
  ru: {
    ...
    pricingDesc: 'Никаких скрытых платежей. Есть бесплатный тариф.',
    perMonth: '/мес',
    ...
    faq4a: 'Оплата через Click или банковский перевод. Есть бесплатный тариф, платные от 99 000 сум/мес. AI-сервисы оплачиваются через баланс.',
